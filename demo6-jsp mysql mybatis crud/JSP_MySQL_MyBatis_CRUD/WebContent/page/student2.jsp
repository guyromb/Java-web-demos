...
<script>
    ...
    /* $("#queryButton").on("click",function(){
        $.ajax({
            type: 'POST',
            url: "http://localhost:8081/JSP_MySQL_MyBatis_CRUD/queryAll.do",
    ...
    $("#addButton").on("click",function(){
        ...
        if((id!="")&&(name!="")&&(phone!="")){
        	...
        	$.ajax({
                type: 'POST',
                url: "http://localhost:8081/JSP_MySQL_MyBatis_CRUD/addOne.do",
                contentType: "application/json; charset=utf-8",
  	...
  	$("#updateButton").on("click", function() {
    	...
    	if((id!="")&&(name!="")&&(phone!="")){
    	    ...
    	    $.ajax({
				type: 'POST',
    	        url: "http://localhost:8081/JSP_MySQL_MyBatis_CRUD/updateOne.do",
    	        contentType: "application/json; charset=utf-8",
    	        data: JSON.stringify(dataJson),
    	        dataType: 'json',
    	        success: function(resp){
	...
	$("table input[name='delete']").on("click", function( e ) {
    	...
    	function doDelete(){
            ...
            $.ajax({
                type: 'POST',
                url: "http://localhost:8081/JSP_MySQL_MyBatis_CRUD/deleteOne.do",
                contentType: "application/json; charset=utf-8",
                data: JSON.stringify(dataJson),
                dataType: 'json',
                success: function(resp){
